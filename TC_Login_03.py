...
class Orange:
    ...
    def __init__(self):
        ...
        self.delete_button = '//span[@class="oxd-icon bi-trash""]//i'
        self.confirm_delete = '//i[text()="Yes, Delete"]'
    ...
    def user_delete(self):
        ...
        delete_webelement = self.driver.find_element(By.CLASS_NAME, self.delete_button)
        delete_webelement.click()
        sleep(2)

        confirm_delete_webelement = self.driver.find_element(By.__text_signature__, self.confirm_delete)
        confirm_delete_webelement.click()
        sleep(2)
